...
def main_Source():
    ...
    sender = initialize_radios (1,16 , SENDER_REPEATER_CHANNEL)
    receiver = initialize_radios (0, 20, REPEATER_SENDER_CHANNEL)
...
def main_Repeater():
    ...
    receiver = initialize_radios(0, 20, SENDER_REPEATER_CHANNEL)
